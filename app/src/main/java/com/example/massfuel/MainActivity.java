...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView fuelOut; // поле вывода результирующей информации
    ...
    protected void onCreate(Bundle savedInstanceState) { // создание жизненного цикла активности
        ...
        fuelOut = findViewById(R.id.fuelOut); // поле вывода
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            fuelOut.setText("Для вывода на орбиту Марса, введённой массы груза, потребуется " + algorithm.fuelMassCalculation(mass) + " кг топлива");
        }
    };
}